...
export default function ReservationDetailPage() {
  ...
  if (status === RESERVATION_STATUS.HELD) {
    return <Navigate to={ROUTES.reservationPayment(reservationId)} replace />;
  }
  ...
  return (
    <>
      <nav className="crumb" aria-label="현재 위치">
        <Link to={ROUTES.reservations}>내 예약</Link>
        <span>›</span>
      ...
      <div className="split">
        ...
        <aside className="sticky">
          ...
          <p className="note">
            출입은 <Link to={ROUTES.door} className="soft-link">모의 출입 단말</Link>에서 확인합니다.
          </p>
        </aside>
      </div>

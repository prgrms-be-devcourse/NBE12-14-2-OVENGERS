...
export default function AdminSpaceFormPage({ mode = 'create' }) {
  ...
  return (
    <>
      <nav className="crumb" aria-label="현재 위치">
        <Link to={ROUTES.adminSpaces}>공간 관리</Link>
        <span>›</span>
      ...
      <SpaceForm
        ...
        onCancel={() => navigate(ROUTES.adminSpaces)}
      />
    </>
  );
}

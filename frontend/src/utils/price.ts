...
export function calculateTotal(
  pricePerSlot: number | null | undefined,
...
export function calculateTotalByRange(
  pricePerSlot: number,
  startTime: string,
  endTime: string,
): number {
...
/** 5000 → '30분당 5,000원' */
export function formatPricePerSlot(pricePerSlot: number): string {
...
export function formatCredit(amount: number | null | undefined): string {
  if (amount === null || amount === undefined) return '-';
